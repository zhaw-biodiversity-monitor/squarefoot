...
# data
squarefoot <- read_csv("one-off scripts/Squarefoot_data_long_eng.csv")
...
dependent_vars <- c("Altitude",
                   ...
                   "Functional_diversity_specific_leaf_area",
                   "Functional_diversity_seed_mass",
                   "Functional_diversity_height",
                   "Temperature",
                   "Nutrient",
                   "Reaction",
                   "Moisture",
                   ...
                   "Cover_Poaceae",
                   "Cover_Forb",
                   "Cover_Cyperaceae_and_Juncaceae",
                   "Stress_tolerance",
