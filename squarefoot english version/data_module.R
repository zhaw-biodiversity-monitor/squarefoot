...
#library(readxl)
threshold_delta <- read_xlsx("appdata/threshold_definitions_delta_eng.xlsx", sheet="Schwellenwerte")
threshold_res_hist <- read_xlsx("appdata/threshold_definitions_res_hist_eng.xlsx", sheet="Schwellenwerte")
