...
#write.csv(merged_data, "C:/Users/hedd/Documents/Dashboard VegChange Projekt/Squarefoot/Squarefoot code/Squarefoot_data.csv", row.names = FALSE)
...
write.csv(dataset_long,"C:/Users/hedd/Documents/Dashboard VegChange Projekt/Squarefoot/Squarefoot code/Squarefoot_data_long.csv", row.names = FALSE)
